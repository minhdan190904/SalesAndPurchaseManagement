...
(N'Sofa'),                  -- Sofas
(N'Giường'),                -- Beds
(N'Tủ quần áo'),            -- Wardrobes
(N'Bàn làm việc'),          -- Desks
(N'Giá sách'),              -- Bookshelves
(N'Tủ đồ'),                 -- Cabinets
(N'Kệ TV'),                 -- TV Stands
(N'Bàn cà phê');            -- Coffee Tables
...
VALUES 
    (N'Bàn Gỗ Chống Nước', 120, 60, 75, N'Nâu', 1, 1, 1, 1, 1, 1, 1, 10, 500000, 700000, 24, N'1.png', N'Bàn gỗ có tính năng chống nước.'),
    (N'Ghế Kim Loại Gấp', 45, 45, 90, N'Xám', 2, 2, 2, 2, 2, 2, 2, 15, 200000, 350000, 12, N'1.png', N'Ghế kim loại có thể gấp gọn.'),
    (N'Bàn Nhựa Bền Màu', 100, 50, 70, N'Trắng', 1, 1, 3, 1, 3, 3, 1, 20, 150000, 250000, 18, N'1.png', N'Bàn nhựa bền màu, dễ lau chùi.'),
    (N'Ghế Gỗ Xoay', 50, 50, 100, N'Đen', 2, 2, 1, 1, 1, 1, 2, 8, 300000, 450000, 24, N'1.png', N'Ghế gỗ có tính năng xoay.'),
    (N'Bàn Kính Chống Trầy', 120, 60, 75, N'Trong suốt', 1, 3, 4, 2, 1, 1, 3, 5, 1000000, 1500000, 12, N'1.png', N'Bàn kính chống trầy, sang trọng.'),
    (N'Tủ Kim Loại Chống Bụi', 80, 40, 150, N'Xanh', 3, 4, 2, 3, 2, 2, 4, 6, 500000, 800000, 18, N'1.png', N'Tủ kim loại chống bụi, bảo vệ đồ đạc.'),
    (N'Ghế Vải Thoải Mái', 60, 60, 100, N'Xanh đậm', 2, 2, 5, 4, 3, 3, 5, 7, 400000, 600000, 12, N'1.png', N'Ghế vải thoáng mát và thoải mái.'),
    (N'Bàn Gỗ Bền', 150, 70, 80, N'Nâu nhạt', 1, 1, 1, 2, 4, 1, 1, 12, 600000, 850000, 36, N'1.png', N'Bàn gỗ bền và chắc chắn.'),
    (N'Ghế Nhựa Gấp', 45, 45, 90, N'Đỏ', 2, 2, 3, 1, 5, 2, 2, 30, 120000, 220000, 6, N'1.png', N'Ghế nhựa có thể gấp gọn.'),
    (N'Tủ Kính Cường Lực', 60, 40, 180, N'Trong suốt', 3, 3, 4, 2, 1, 3, 2, 3, 800000, 1200000, 24, N'1.png', N'Tủ kính bền và chịu lực.'),
    (N'Giường Gỗ Chống Thấm', 200, 160, 100, N'Nâu sẫm', 4, 1, 1, 3, 4, 1, 1, 5, 1500000, 2000000, 36, N'1.png', N'Giường gỗ có khả năng chống thấm.'),
    (N'Sofa Vải Dài', 180, 90, 80, N'Xám nhạt', 5, 2, 5, 4, 1, 2, 5, 2, 1200000, 1800000, 24, N'1.png', N'Sofa vải rộng rãi và thoải mái.'),
    (N'Bàn Kính Chống Nước', 100, 50, 75, N'Đen', 1, 1, 4, 1, 3, 3, 3, 8, 900000, 1300000, 18, N'1.png', N'Bàn kính với bề mặt chống nước.'),
    (N'Ghế Kim Loại Kháng Bụi', 45, 45, 95, N'Đen', 2, 2, 2, 2, 2, 1, 4, 12, 250000, 400000, 12, N'1.png', N'Ghế kim loại chống bụi, dễ vệ sinh.'),
    (N'Giường Vải Thoáng Mát', 220, 160, 110, N'Xanh ngọc', 4, 2, 5, 4, 5, 2, 5, 4, 1800000, 2500000, 36, N'1.png', N'Giường vải rộng rãi, dễ chịu.'),
    (N'Tủ Gỗ Cao', 80, 40, 200, N'Nâu', 3, 4, 1, 2, 3, 1, 4, 10, 1200000, 1800000, 24, N'1.png', N'Tủ gỗ cao, có sức chứa lớn.'),
    (N'Ghế Nhựa Dẻo', 40, 40, 90, N'Vàng', 2, 2, 3, 3, 4, 2, 5, 25, 100000, 200000, 6, N'1.png', N'Ghế nhựa dẻo, dễ di chuyển.'),
    (N'Sofa Kim Loại Kháng Bụi', 200, 100, 85, N'Đen', 5, 2, 2, 1, 5, 3, 4, 3, 1700000, 2300000, 24, N'1.png', N'Sofa kim loại kháng bụi, sang trọng.'),
    (N'Tủ Nhựa Chống Ẩm', 80, 40, 150, N'Trắng', 3, 3, 3, 2, 4, 1, 2, 18, 600000, 950000, 18, N'1.png', N'Tủ nhựa nhẹ, chống ẩm mốc.'),
    (N'Giường Kim Loại Cao', 200, 150, 90, N'Đen bóng', 4, 4, 2, 3, 2, 2, 5, 6, 1600000, 2100000, 36, N'1.png', N'Giường kim loại vững chắc, chiều cao tốt.'),
    (N'Bàn Vải Đơn Giản', 60, 40, 50, N'Xám', 1, 1, 5, 4, 3, 3, 1, 20, 250000, 400000, 12, N'1.png', N'Bàn vải nhỏ gọn, phù hợp nhiều không gian.'),
    (N'Ghế Gỗ Đệm', 45, 45, 95, N'Nâu đỏ', 2, 2, 1, 1, 1, 1, 1, 15, 300000, 500000, 12, N'1.png', N'Ghế gỗ có đệm thoải mái.'),
    (N'Sofa Nhựa Sang Trọng', 200, 100, 85, N'Trắng ngà', 5, 2, 3, 2, 5, 1, 5, 9, 1400000, 1900000, 24, N'1.png', N'Sofa nhựa phong cách sang trọng.'),
    ...
    (N'Ghế Kim Loại Đệm', 45, 45, 90, N'Đen', 2, 2, 2, 1, 3, 1, 4, 12, 220000, 370000, 12, N'1.png', N'Ghế kim loại có đệm ngồi thoải mái.'),
    (N'Sofa Gỗ Chịu Lực', 180, 90, 80, N'Xám', 5, 3, 1, 3, 4, 2, 1, 4, 1200000, 1500000, 18, N'1.png', N'Sofa gỗ có độ bền cao.'),
    (N'Tủ Nhựa Mini', 50, 40, 80, N'Trắng', 3, 4, 3, 2, 5, 3, 2, 30, 250000, 400000, 6, N'1.png', N'Tủ nhựa mini tiện lợi.'),
    (N'Giường Kính Sang Trọng', 220, 160, 90, N'Đen', 4, 2, 4, 3, 2, 3, 5, 2, 1900000, 2600000, 36, N'1.png', N'Giường kính phong cách sang trọng.'),
    (N'Bàn Kim Loại Cỡ Lớn', 140, 60, 75, N'Xám', 1, 1, 2, 1, 1, 3, 3, 7, 400000, 600000, 12, N'1.png', N'Bàn kim loại bền bỉ, rộng rãi.'),
    (N'Ghế Gỗ Cao', 50, 50, 100, N'Nâu', 2, 4, 1, 4, 4, 2, 2, 25, 350000, 500000, 12, N'1.png', N'Ghế gỗ cao, dễ ngồi.'),
    (N'Sofa Kính Chịu Lực', 200, 90, 85, N'Trong suốt', 5, 3, 4, 2, 5, 1, 4, 4, 1500000, 2000000, 24, N'1.png', N'Sofa kính sang trọng và chắc chắn.'),
    (N'Tủ Gỗ Cao', 60, 40, 170, N'Nâu đậm', 3, 4, 1, 1, 3, 1, 2, 8, 900000, 1300000, 24, N'1.png', N'Tủ gỗ đứng, có sức chứa lớn.'),
    (N'Ghế Nhựa Chống Thấm', 45, 45, 85, N'Xanh', 2, 2, 3, 1, 1, 2, 1, 30, 120000, 250000, 6, N'1.png', N'Ghế nhựa có tính năng chống thấm.'),
    (N'Bàn Vải Nhỏ Gọn', 60, 40, 50, N'Xám đen', 1, 1, 5, 4, 1, 1, 2, 5, 200000, 320000, 6, N'1.png', N'Bàn vải tiện dụng và nhỏ gọn.'),
    ...
    (N'Bàn Kim Loại Đơn Giản', 120, 60, 75, N'Xám', 1, 1, 2, 1, 2, 3, 5, 10, 500000, 750000, 18, N'1.png', N'Bàn kim loại đơn giản, phù hợp mọi không gian.'),
    (N'Ghế Vải Bền', 50, 50, 90, N'Xanh', 2, 2, 5, 1, 5, 2, 3, 12, 300000, 450000, 12, N'1.png', N'Ghế vải bền và dễ di chuyển.'),
    (N'Bàn Gỗ Chống Nước', 120, 60, 75, N'Nâu', 1, 1, 1, 1, 1, 1, 1, 10, 500000, 700000, 24, N'1.png', N'Bàn gỗ có tính năng chống nước.'),
    (N'Ghế Kim Loại Gấp', 45, 45, 90, N'Xám', 2, 2, 2, 2, 2, 2, 2, 15, 200000, 350000, 12, N'1.png', N'Ghế kim loại có thể gấp gọn.'),
    (N'Bàn Nhựa Bền Màu', 100, 50, 70, N'Trắng', 1, 1, 3, 1, 3, 3, 1, 20, 150000, 250000, 18, N'1.png', N'Bàn nhựa bền màu, dễ lau chùi.'),
    (N'Ghế Gỗ Xoay', 50, 50, 100, N'Đen', 2, 2, 1, 1, 1, 1, 2, 8, 300000, 450000, 24, N'1.png', N'Ghế gỗ có tính năng xoay.'),
    ...
    (N'Ghế Vải Thoải Mái', 60, 60, 100, N'Xanh đậm', 2, 2, 5, 4, 3, 3, 5, 7, 400000, 600000, 12, N'1.png', N'Ghế vải thoáng mát và thoải mái.'),
    (N'Bàn Gỗ Bền', 150, 70, 80, N'Nâu nhạt', 1, 1, 1, 2, 4, 1, 4, 12, 600000, 850000, 36, N'1.png', N'Bàn gỗ bền và chắc chắn.'),
    (N'Ghế Nhựa Gấp', 45, 45, 90, N'Đỏ', 2, 2, 3, 1, 5, 2, 2, 30, 120000, 220000, 6, N'1.png', N'Ghế nhựa có thể gấp gọn.'),
    (N'Tủ Kính Cường Lực', 60, 40, 180, N'Trong suốt', 3, 3, 4, 2, 1, 2, 5, 3, 800000, 1200000, 24, N'1.png', N'Tủ kính bền và chịu lực.'),
    (N'Giường Gỗ Chống Thấm', 200, 160, 100, N'Nâu sẫm', 4, 1, 1, 3, 4, 3, 1, 5, 1500000, 2000000, 36, N'1.png', N'Giường gỗ có khả năng chống thấm.'),
    (N'Sofa Vải Dài', 180, 90, 80, N'Xám nhạt', 5, 2, 5, 4, 1, 2, 5, 2, 1200000, 1800000, 24, N'1.png', N'Sofa vải rộng rãi và thoải mái.'),
    (N'Bàn Kính Chống Nước', 100, 50, 75, N'Đen', 1, 1, 4, 1, 3, 3, 3, 8, 900000, 1300000, 18, N'1.png', N'Bàn kính với bề mặt chống nước.'),
    (N'Ghế Kim Loại Kháng Bụi', 45, 45, 95, N'Đen', 2, 2, 2, 2, 2, 1, 4, 12, 250000, 400000, 12, N'1.png', N'Ghế kim loại chống bụi, dễ vệ sinh.'),
    (N'Giường Vải Thoáng Mát', 220, 160, 110, N'Xanh ngọc', 4, 2, 5, 4, 5, 1, 5, 4, 1800000, 2500000, 36, '1.png', 'Giường vải rộng rãi, dễ chịu.'),
    (N'Tủ Gỗ Cao', 80, 40, 200, N'Nâu', 3, 4, 1, 2, 3, 1, 1, 10, 1200000, 1800000, 24, N'1.png', N'Tủ gỗ cao, có sức chứa lớn.'),
    (N'Ghế Nhựa Dẻo', 40, 40, 90, N'Vàng', 2, 2, 3, 3, 4, 2, 2, 25, 100000, 200000, 6, N'1.png', 'Ghế nhựa dẻo, dễ di chuyển.'),
    (N'Sofa Kim Loại Kháng Bụi', 200, 100, 85, N'Đen', 5, 2, 2, 1, 5, 2, 4, 3, 1700000, 2300000, 24, N'1.png', N'Sofa kim loại kháng bụi, sang trọng.'),
    (N'Tủ Nhựa Chống Ẩm', 80, 40, 150, N'Trắng', 3, 3, 3, 2, 4, 2, 2, 18, 600000, 950000, 18, N'1.png', N'Tủ nhựa nhẹ, chống ẩm mốc.'),
    (N'Giường Kim Loại Cao', 200, 150, 90, N'Đen bóng', 4, 4, 2, 3, 2, 3, 3, 6, 1600000, 2100000, 36, '1.png', N'Giường kim loại vững chắc, chiều cao tốt.'),
    (N'Bàn Vải Đơn Giản', 60, 40, 50, N'Xám', 1, 1, 5, 4, 3, 1, 1, 20, 250000, 400000, 12, N'1.png', N'Bàn vải nhỏ gọn, phù hợp nhiều không gian.'),
    (N'Ghế Gỗ Đệm', 45, 45, 95, N'Nâu đỏ', 2, 2, 1, 1, 1, 1, 1, 15, 300000, 500000, 12, N'1.png', N'Ghế gỗ có đệm thoải mái.'),
    (N'Sofa Nhựa Sang Trọng', 200, 100, 85, N'Trắng ngà', 5, 2, 3, 2, 5, 1, 2, 9, 1400000, 1900000, 24, '1.png', N'Sofa nhựa phong cách sang trọng.'),
    (N'Tủ Nhựa Đựng Đồ', 50, 40, 130, N'Xám', 3, 3, 3, 4, 2, 1, 4, 8, 500000, 750000, 12, N'1.png', N'Tủ nhựa tiện lợi, phù hợp mọi không gian.'),
    (N'Bàn Gỗ Mini', 80, 50, 40, N'Nâu sáng', 1, 1, 1, 1, 1, 1, 2, 10, 150000, 300000, 6, N'1.png', N'Bàn gỗ kích thước nhỏ gọn.'),
    (N'Ghế Kim Loại Đệm', 45, 45, 90, N'Đen', 2, 2, 2, 1, 3, 2, 4, 12, 220000, 370000, 12, N'1.png', N'Ghế kim loại có đệm ngồi thoải mái.'),
    (N'Sofa Gỗ Chịu Lực', 180, 90, 80, N'Xám', 5, 3, 1, 3, 4, 3, 3, 4, 1200000, 1500000, 18, N'1.png', N'Sofa gỗ có độ bền cao.'),
    (N'Tủ Nhựa Mini', 50, 40, 80, N'Trắng', 3, 4, 3, 2, 5, 2, 2, 30, 250000, 400000, 6, N'1.png', N'Tủ nhựa mini tiện lợi.'),
    (N'Giường Kính Sang Trọng', 220, 160, 90, N'Đen', 4, 2, 4, 3, 2, 2, 5, 2, 1900000, 2600000, 36, N'1.png', N'Giường kính phong cách sang trọng.'),
    (N'Bàn Kim Loại Cỡ Lớn', 140, 60, 75, N'Xám', 1, 1, 2, 1, 1, 3, 3, 7, 400000, 600000, 12, N'1.png', N'Bàn kim loại bền bỉ, rộng rãi.'),
    (N'Ghế Gỗ Cao', 50, 50, 100, N'Nâu', 2, 4, 1, 4, 4, 1, 2, 25, 350000, 500000, 12, N'1.png', N'Ghế gỗ cao, dễ ngồi.'),
    (N'Sofa Kính Chịu Lực', 200, 90, 85, N'Trong suốt', 5, 3, 4, 2, 5, 3, 4, 4, 1500000, 2000000, 24, N'1.png', N'Sofa kính sang trọng và chắc chắn.'),
    (N'Tủ Gỗ Cao', 60, 40, 170, N'Nâu đậm', 3, 4, 1, 1, 3, 2, 2, 8, 900000, 1300000, 24, N'1.png', N'Tủ gỗ đứng, có sức chứa lớn.'),
    (N'Ghế Nhựa Chống Thấm', 45, 45, 85, N'Xanh', 2, 2, 3, 1, 5, 2, 1, 30, 120000, 250000, 6, N'1.png', N'Ghế nhựa có tính năng chống thấm.'),
    (N'Bàn Vải Nhỏ Gọn', 60, 40, 50, N'Xám đen', 1, 1, 5, 4, 1, 1, 4, 5, 200000, 320000, 6, N'1.png', N'Bàn vải tiện dụng và nhỏ gọn.'),
    ...
    (N'Bàn Kim Loại Đơn Giản', 120, 60, 75, N'Xám', 1, 1, 2, 1, 2, 2, 5, 10, 500000, 750000, 18, N'1.png', N'Bàn kim loại đơn giản, phù hợp mọi không gian.'),
    (N'Ghế Vải Bền', 50, 50, 90, N'Xanh', 2, 2, 5, 1, 5, 2, 2, 12, 300000, 450000, 12, N'1.png', N'Ghế vải bền và dễ di chuyển.');
...
-- InvoiceId 11
(3, 1, '2024-02-15T14:30:00', 8500000),
-- InvoiceId 12
(3, 2, '2024-02-18T08:30:00', 7200000),
-- InvoiceId 13
(1, 3, '2024-02-20T15:00:00', 9300000),
-- InvoiceId 14
(1, 4, '2024-03-01T12:00:00', 11000000),
-- InvoiceId 15
(2, 5, '2024-03-05T09:00:00', 5500000),
-- InvoiceId 16
(2, 1, '2024-03-10T16:45:00', 4600000),
-- InvoiceId 17
(3, 2, '2024-03-15T11:30:00', 8500000),
-- InvoiceId 18
(3, 3, '2024-03-20T08:00:00', 6400000),
-- InvoiceId 19
(1, 4, '2024-03-25T14:15:00', 9000000),
-- InvoiceId 20
(1, 5, '2024-03-30T10:45:00', 7800000),

-- InvoiceId 21
(2, 1, '2024-04-05T09:00:00', 9500000),
-- InvoiceId 22
(2, 2, '2024-04-10T12:30:00', 8300000),
-- InvoiceId 23
(3, 3, '2024-04-15T11:00:00', 7100000),
-- InvoiceId 24
(3, 4, '2024-04-20T14:00:00', 6700000),
-- InvoiceId 25
(1, 5, '2024-04-25T09:45:00', 8500000),
-- InvoiceId 26
(1, 1, '2024-04-30T15:15:00', 9500000),
-- InvoiceId 27
(2, 2, '2024-05-05T11:00:00', 5600000),
-- InvoiceId 28
(2, 3, '2024-05-10T10:30:00', 8400000),
-- InvoiceId 29
(3, 4, '2024-05-15T12:15:00', 6700000),
-- InvoiceId 30
(3, 5, '2024-05-20T13:45:00', 7800000),

-- InvoiceId 31
(1, 1, '2024-05-25T09:30:00', 9300000),
-- InvoiceId 32
(1, 2, '2024-05-30T10:00:00', 6400000),
-- InvoiceId 33
(2, 3, '2024-06-01T11:00:00', 8800000),
-- InvoiceId 34
(2, 4, '2024-06-05T12:00:00', 5400000),
-- InvoiceId 35
(3, 5, '2024-06-10T09:15:00', 9500000),
-- InvoiceId 36
(3, 1, '2024-06-15T08:45:00', 7600000),
-- InvoiceId 37
(1, 2, '2024-06-20T14:30:00', 8900000),
-- InvoiceId 38
(1, 3, '2024-06-25T10:30:00', 6700000),
-- InvoiceId 39
(2, 4, '2024-07-01T12:45:00', 7800000),
-- InvoiceId 40
(2, 5, '2024-07-05T13:00:00', 8200000);
